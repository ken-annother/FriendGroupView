...
public class CommitBaseAdapter extends BaseAdapter {

	Context context;
	List<CommitBean> chatList;
	
	public CommitBaseAdapter(Context context,List<CommitBean> chatList) {
	...
	@Override
	public CommitBean getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CommitBean chatBean = chatList.get(position);
